...
const GradientBlinds = ({
    ...
    useEffect(() => {
        ...
        // 🔥 FIX: Get dimensions BEFORE creating renderer
...
`;
        ...
        // 🔥 FIX: Calculate initial blind count and mouse position
        const initialBlindCount = blindMinWidth && blindMinWidth > 0
            ? Math.min(blindCount, Math.floor(initialWidth / blindMinWidth))
            : blindCount;
        ...
        const uniforms = {
            ...
            uNoise: { value: noise },
            uBlindCount: { value: Math.max(1, initialBlindCount) },
