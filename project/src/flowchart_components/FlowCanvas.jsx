...
import { Link, Plus, Type, Layers, Trash2, /*Undo2, Redo2,*/Hand,Send,SquareArrowOutUpRight} from 'lucide-react';
...
function FlowCanvasInner() {
    ...
    //storing position and previous settings.
    ...
    useEffect(() => {
        ...
        window.addEventListener("add-flow-node", handleAddFlowNode);
        return () => window.removeEventListener("add-flow-node", handleAddFlowNode);
    ...
    const addSelectedNodeToTodo = useCallback(() => {
    ...
    const items = [
        ...
        {
            label: "Add to TODO",
            onClick: addSelectedNodeToTodo,
            icon: <SquareArrowOutUpRight size={24} />
        },
        {
            label: panMode ? "Pan Mode" : "Select Mode",
        ...
        {
            label: glassBg ? "Image BG" : "Glass BG",
            onClick: () => setGlassBg(v => !v),
            icon: <Layers size={24} />,
        },
