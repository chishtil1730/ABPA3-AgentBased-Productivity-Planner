...
export default function NodeCustom({ id, data, selected }) {
    ...
    const containerStyle = {
        ...
        background: selected
            ? "linear-gradient(180deg, rgba(255,255,255,0.33), rgba(255,255,255,0.12))"
        ...
        boxShadow: selected
            ? "inset 0 0 45px rgba(255,255,255,0.3), 0 12px 30px rgba(0,0,0,0.37)"
    ...
    const baseInput = {
        ...
        spellCheck: false,
        color: "#fff",
        fontFamily: "Unbounded",   // ← your font restored
    };
